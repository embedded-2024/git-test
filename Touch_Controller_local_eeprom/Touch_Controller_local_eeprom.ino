...
void setup() {
  ...
  // int_setup();  // to change devicenum and nozzlenum
...
void int_setup() {  //  to change devicenum and nozzlenum
  ...
  // writeStringToEEPROM(260, "002-Octane Ron(95)");   // for eight nozzle
  // writeStringToEEPROM(290, "004-Diesel");
  // writeStringToEEPROM(330, "001-Octane Ron(92)");
  // writeStringToEEPROM(360, "005-Premium Diesel");
